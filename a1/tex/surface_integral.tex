...
%This dirty hack is needed because section* does not increment the counter, addtocounter doesn't reset the subsection numbering, and setcounter{subsection}{2} has no effect whatsoever.  Sigh.
\invisiblesection{}
...
\begin{align}
  \oiint_{\partial\Omega} \mathbf{E} \cdot d\mathbf{S} =& \ \! \frac{1}{\varepsilon_0} \iiint_\Omega \rho \ \! \D V \\
  ...
  \oint_{\partial\Sigma} \mathbf{B} \cdot \D \ell =& \ \! \mu_0 \iint_\Sigma \left(\mathbf{J} + \varepsilon_0 \frac{\partial \mathbf{E}}{\partial t} \right) \cdot \D \mathbf {S}
\end{align}
